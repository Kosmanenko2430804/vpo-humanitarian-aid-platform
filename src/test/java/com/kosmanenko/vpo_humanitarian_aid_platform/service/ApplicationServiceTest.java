...
class ApplicationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        provider = User.builder().id(1L).email("provider@test.com").fullName("Надавач").build();
    ...
    void apply_success_savesAndPublishesEvent() {
        ...
        HelpApplication result = applicationService.apply(announcement, applicant, "Потребую допомоги");
    ...
    void apply_throwsException_whenDoesNotAcceptApplications() {
        ...
        assertThatThrownBy(() -> applicationService.apply(announcement, applicant, "Текст"))
    ...
    void accept_pendingApplication_setsAccepted_andPublishesEvent() {
        ...
        applicationService.accept(1L, pickupDate, "вул. Хрещатик 1", "+380501234567", provider);
    ...
    void complete_acceptedApplication_setsCompleted_andPublishesEvent() {
        ...
        applicationService.complete(1L, provider);
